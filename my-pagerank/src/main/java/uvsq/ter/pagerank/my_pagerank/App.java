package uvsq.ter.pagerank.my_pagerank;
...
public final class App {
  ...
  public static void main(String[] args) throws Exception {
     ...
     */
    //showWarning();
	  System.out.println(" avan le  builder");
    ...
    SparkSession spark = SparkSession
	  ...
	  System.out.println(" apres le  builder");
    ...
    //     URL         neighbor URL
    //     ...
    String chemin = new File("").getAbsolutePath()+"src/main/java/resources/fichier_test_url_small";
    JavaRDD<String> lines = spark.read().textFile(chemin).javaRDD();
